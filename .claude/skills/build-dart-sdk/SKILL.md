...
```bash
# Specify architecture (default: auto-detected from host)
bash .claude/skills/build-dart-sdk/scripts/build.sh --arch arm64 runtime
bash .claude/skills/build-dart-sdk/scripts/build.sh --arch x64 create_sdk
```

Supported architectures: `x64`, `arm64`, `arm`, `riscv64`.
