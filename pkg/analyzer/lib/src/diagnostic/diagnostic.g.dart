...
recordSpreadNotRecordType = DiagnosticWithArguments(
  ...
  problemMessage:
      "A spread expression in a record literal must have a record type, but "
      "has type '{0}'.",
...
recordSpreadDuplicateNamedField = DiagnosticWithArguments(
  ...
  problemMessage:
      "The named field '{0}' from the spread conflicts with another field "
      "with the same name.",
  correctionMessage:
      "Try renaming one of the fields, or removing the spread.",
  type: DiagnosticType.COMPILE_TIME_ERROR,
